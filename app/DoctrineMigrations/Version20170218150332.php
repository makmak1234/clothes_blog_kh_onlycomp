 ...
 */
class Version20170218150332 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE children_goods_subcategory_children_goods (children_goods_subcategory_id INT NOT NULL, children_goods_id INT NOT NULL, INDEX IDX_BE7C2328E1CB5670 (children_goods_subcategory_id), INDEX IDX_BE7C2328A6916636 (children_goods_id), PRIMARY KEY(children_goods_subcategory_id, children_goods_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE children_goods_a (id INT AUTO_INCREMENT NOT NULL, description_goods_id INT DEFAULT NULL, price_goods_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, position INT NOT NULL, prodDatetime DATETIME NOT NULL, prodDatetimeUpdate DATETIME NOT NULL, draft TINYINT(1) DEFAULT NULL, INDEX IDX_2C80A9D525BD7B1 (description_goods_id), INDEX IDX_2C80A9D5D5DE0E82 (price_goods_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE children_goods_subcategory_children_goods ADD CONSTRAINT FK_BE7C2328E1CB5670 FOREIGN KEY (children_goods_subcategory_id) REFERENCES children_goods_subcategory_a (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE children_goods_subcategory_children_goods ADD CONSTRAINT FK_BE7C2328A6916636 FOREIGN KEY (children_goods_id) REFERENCES children_goods_a (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE children_goods_subcategory_children_goods DROP FOREIGN KEY FK_BE7C2328E1CB5670');
        ...
        $this->addSql('ALTER TABLE children_goods_subcategory_children_goods DROP FOREIGN KEY FK_BE7C2328A6916636');
        ...
        $this->addSql('DROP TABLE children_goods_subcategory_children_goods');
